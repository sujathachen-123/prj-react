...
function BasicExample({ searchQuery }) {
  ...
  const courses = [
    ...
    {
      title: "Angular Basics", text: "Learn Angular from scratch.", image: angular, price: 499, rating: { rate: 4.7, count: 512 }, buttonText: "Start Angular",
    },
    {
      title: "React Essentials", text: "Master React.js for web development.", image: react,price: 499,rating: { rate: 4.8, count: 601 }, buttonText: "Start React",
    },
    {
      title: "SQL for Beginners", text: "Learn SQL and manage databases effectively.", image: sql, price: 399, rating: { rate: 4.6, count: 357 }, buttonText: "Start SQL",
    },
  ];
